...
class Profile(models.Model):
    ...
    surname = models.CharField(max_length=20, default='Аноним')
    gender = models.CharField(max_length=10, choices=CHOICES_GENDER, default=CHOICES_GENDER[0][0])
    sport_type = models.CharField(max_length=10, choices=CHOICES_SPORTS, default=CHOICES_SPORTS[0][0])
    characteristics = models.TextField()
    athlete_photo = models.ImageField(upload_to='athlete_photos/%Y/%m/%d', blank=True, null=True,
                                      default='athlete_photos/defaultProfile.jpg')
